...
// ✅ Fade-in Animation Variant (Now Used)
...
export function CarCard({ car, isFavorite, onToggleFavorite }: CarCardProps) {
  return (
    <motion.div
      ...
      variants={fadeInUpVariants} // ✅ Now correctly applied
      initial="hidden"
      animate="visible"
    >
      ...
      <div className="flex justify-between items-start mb-4">
        ...
        <button
          ...
          className={`${
            isFavorite ? "text-red-500" : "text-[#90A3BF] dark:text-gray-400"
      ...
      <div className="flex items-center justify-between pt-4 mt-4 border-t border-gray-100 dark:border-gray-700">
        <div>
          ...
          {car.originalPrice && (
            <p className="text-sm text-[#90A3BF] dark:text-gray-500 line-through">
              {car.originalPrice}
            </p>
          )}
        </div>
