...
export default function BookARide() {
  ...
  useEffect(() => {
    const isValid = Object.values(formData).every((value) => value !== "") && licenseImage !== null
  ...
  if (!car) return <div className="text-gray-900 dark:text-gray-100 p-4">Loading...</div>
    ...
    >
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-bold text-[#3563E9] dark:text-blue-400 mb-2">Book Your {car.name}</h1>
          <div className="flex items-center gap-2 text-[#90A3BF] dark:text-gray-400">
            <span>4.8</span>
        ...
        <div className="space-y-8">
          ...
          >
            <div className="relative h-96 w-full mb-6">
              <Image src={car.image || "/placeholder.svg"} alt={car.name} fill className="object-contain rounded-lg" />
              <button
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              ...
              <div className="feature-card dark:bg-gray-700 dark:border-gray-600">
                ...
                <span className="text-[#90A3BF] dark:text-gray-400 text-sm">capacity</span>
              </div>
            </div>
      ...
      {toast.visible && (
          <Toast
            ...
            darkModeClass="dark:bg-gray-700 dark:text-white"
          />
      )}
    </motion.div>
  )
