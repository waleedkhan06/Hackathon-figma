...
export default function CarRental() {
  ...
  const updateFilterCounts = (cars: Car[]) => {
    ...
    // Count occurrences for types and capacities
    cars.forEach((car) => {
    ...
    // Update filter counts immutably
    setFilters((prev) => ({
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-4">
                <input
                  ...
                  className="w-4 h-4 text-[#3563E9] dark:text-gray-300 border-[#3563E9] dark:border-gray-600 focus:ring-[#3563E9]"
                />
                <label htmlFor="pickup" className="text-sm font-medium text-[#1A202C] dark:text-white">
                  Pick - Up
                </label>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm text-[#90A3BF] dark:text-gray-300 mb-2">Locations</label>
                  <select className="w-full h-10 sm:h-12 bg-[#F6F7F9] dark:bg-gray-700 rounded-lg px-4 text-sm text-[#1A202C] dark:text-white border border-[#C3D4E9] dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-[#3563E9]">
                ...
                <div>
                  <label className="block text-sm text-[#90A3BF] dark:text-gray-300 mb-2">Date</label>
                  <select className="w-full h-10 sm:h-12 bg-[#F6F7F9] dark:bg-gray-700 rounded-lg px-4 text-sm text-[#1A202C] dark:text-white border border-[#C3D4E9] dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-[#3563E9]">
                ...
                <div>
                  <label className="block text-sm text-[#90A3BF] dark:text-gray-300 mb-2">Time</label>
                  <select className="w-full h-10 sm:h-12 bg-[#F6F7F9] dark:bg-gray-700 rounded-lg px-4 text-sm text-[#1A202C] dark:text-white border border-[#C3D4E9] dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-[#3563E9]">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-4">
                <input
                  ...
                  className="w-4 h-4 text-[#3563E9] dark:text-gray-300 border-[#3563E9] dark:border-gray-600 focus:ring-[#3563E9]"
                />
                <label htmlFor="dropoff" className="text-sm font-medium text-[#1A202C] dark:text-white">
                  Drop - Off
                </label>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
